...
if (isset($images->image_intro) and !empty($images->image_intro)) {
	...
	$class = (htmlspecialchars($imgfloat) != 'none') ? ' class="size-auto border align-'.htmlspecialchars($imgfloat).'"' : ' class="size-auto border"';
...
<article class="item" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
  ...
  <?php if ($params->get('show_create_date') || ($params->get('show_author') && !empty($this->item->author)) || $params->get('show_category') || $params->get('show_readmore')) : ?>
