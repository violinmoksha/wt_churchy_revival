...
<?php else : ?>
	...
	<table class="zebra" border="0" cellspacing="0" cellpadding="0">
		...
		<thead>
			<tr>
				<th align="left"><?php echo \Joomla\CMS\HTML\HTMLHelper::_('grid.sort', 'JGLOBAL_TITLE', 'c.core_title', $listDirn, $listOrder); ?></th>
		...
		<tbody>
			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<?php endif; ?>
					...
					<td><?php echo \Joomla\CMS\HTML\HTMLHelper::_('date', $item->displayDate, $this->escape($this->params->get('date_format', \Joomla\CMS\Language\Text::_('DATE_FORMAT_LC3')))); ?></td>
					<?php endif; ?>
